"""
Servicio de OCR usando RapidOCR (modelos PaddleOCR vía ONNX Runtime).
Más rápido que EasyOCR en CPU, sin depender de PaddlePaddle.
"""
...
def detect_text(
    ...
    # RapidOCR devuelve (result, elapse)
